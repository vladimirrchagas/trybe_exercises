...
const changeLesson2 = (object, keyName, value) => object[keyName] = value;
...
console.log(listObjectValue(lesson2));
...
const totalStudents = (object) => {
  ...
  for (let index = 0; index < objectKeys.length; index += 1) {
    totalStudents = totalStudents + object[objectKeys[index]].numeroEstudantes;
  }
...
const getValueByNumber = (object, keyPosition) => {
  const arrayObject = Object.values(object);
  return arrayObject[keyPosition];
}
